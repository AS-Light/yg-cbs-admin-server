...
public class JavaBeanUtil {
    ...
    public static void main(String[] args) {
        CtbServiceContractEntity entity = new CtbServiceContractEntity();
        entity.setCode("111");
        entity.setPartA("222");
        System.out.println(object2Map(entity));

        Map<String, Object> map = new HashMap<>();
        map.put("PartA", "AAA");
        map.put("PartB", "BBB");
        System.out.println(map2Object(map, CtbServiceContractEntity.class));
    }
