 ...
 */
@Data
@TableName("ctb_store_goods_in")
public class CtbStoreGoodsInEntity extends BaseEntity {
    ...
    @ApiModelProperty("ctb_store_goods_in_item")
    @TableField(exist = false)
    private List<CtbStoreGoodsInItemEntity> storeGoodsInItemEntityList;

    @ApiModelProperty("ctb_img_store_goods_in_delivery_order")
    @TableField(exist = false)
    private List<CtbImgStoreGoodsInDeliveryOrderEntity> imgStoreGoodsInDeliveryOrderEntityList;

    @ApiModelProperty("ctb_img_store_goods_in_receipt")
    @TableField(exist = false)
    private List<CtbImgStoreGoodsInReceiptEntity> imgStoreGoodsInReceiptEntityList;
