...
@AllArgsConstructor
@NoArgsConstructor
@Alias("CbsMoneyInEntity")
@TableName("cbs_money_in")
public class CbsMoneyInEntity extends BaseEntity implements Serializable {
    ...
    @TableField(exist = false)
    private List<CbsImgMoneyInEntity> imgMoneyInList;
