...
@NoArgsConstructor
@AllArgsConstructor
@TableName("cbs_import_voyage")
@Alias("CbsImportVoyageEntity")
public class CbsImportVoyageEntity extends BaseEntity implements Serializable {
    ...
    @ApiModelProperty("经停港，入参，变更航次用但是传入进口单")
