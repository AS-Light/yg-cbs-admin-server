...
@AllArgsConstructor
@NoArgsConstructor
@TableName("bind_cbs_ctb_import")
public class BindCbsCtbImportEntity implements Serializable {
     ...
     */
    private Long fkCbsImportId;
    /**
     * 关联ctb加贸表（ctb_order_processing_trade）
     */
    private Long fkCtbImportId;
    /**
     * 是否同步给报关行进行操作
     */
    ...
    @TableField(exist = false)
    private CbsImportEntity cbsImportEntity;

    @ApiModelProperty("ctb_import")
    @TableField(exist = false)
    private CtbImportEntity ctbImportEntity;
